...
const { book } = defineProps<BookCardProps>();
...
// export function BookCard({ book, userRole, onReserve, onDelete, onEdit }: BookCardProps) {
//   const isAvailable = book.availableCopies > 0;
// }

// {/* دکمه‌های مدیریتی برای Admin */} {userRole === 'admin' && (
// <div
//   class="absolute top-3 left-3 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity"
// >
//   <button
//     class="bg-white p-2 rounded-lg shadow-md hover:bg-blue-50 transition-colors"
//     title="ویرایش"
//   >
...
//   </button>
//   <button
//     class="bg-white p-2 rounded-lg shadow-md hover:bg-red-50 transition-colors"
//     title="حذف"
//   >
...
//     }`}>
//       {isAvailable ? `${book.availableCopies} نسخه موجود` : 'ناموجود'}
//     </span>
// </div>
</script>
